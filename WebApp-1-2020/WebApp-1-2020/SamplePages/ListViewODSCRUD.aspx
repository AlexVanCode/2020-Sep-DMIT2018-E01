<%@ Page Title="ODS CRUD!!" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListViewODSCRUD.aspx.cs" Inherits="WebApp_1_2020.SamplePages.ListViewODSCRUD" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1> Single Control ODS CRUD : List View </h1>
    <blockquote>
        ...
        this sample will demonstrate supplied error handling control <br />
        this sample will demonstrate validation on ListView CRUD <br />     
    </blockquote>
